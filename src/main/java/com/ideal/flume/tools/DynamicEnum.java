...
public class DynamicEnum {
	...
	public static <T extends Enum<?>> void addEnum(Class<T> enumType, String enumName, String value) {
		...
		try {
			...
			T newValue = (T) makeEnum(enumType, // The target enum class
					...
					values.size(), new Class<?>[] { String.class }, // could be
																	// used to
																	// pass
					// values to the enum
					// constuctor if needed
					new Object[] { value }); // could be used to pass values to the
	...
	private static enum TestEnum {
		...
		private TestEnum(String channelClassName) {
	...
	public static void main(String[] args) {
		...
		addEnum(TestEnum.class, "d", "D");
		addEnum(TestEnum.class, "e", "E");
		addEnum(TestEnum.class, "f", "F");
		
		TestEnum[] ts = TestEnum.values();
		for (TestEnum t : ts) {
			System.out.println(t.name() + ": " + t.getChannelClassName());
		}

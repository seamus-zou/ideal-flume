...
public class YeeFileEventReader5 {
    private final static Logger logger = LoggerFactory.getLogger(YeeFileEventReader5.class);
    ...
    private YeeFileEventReader5(ClientProps clientProps, CacheClient cacheClient,
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("Initializing {} with directory={}, deserializer={}", new Object[] {
                    YeeFileEventReader5.class.getSimpleName(), spoolDirectory, deserializerType});
        }
                ...
                CollectFileFilter filter = new CollectFileFilter() {
                    public boolean accept(CollectFile candidate) {
                        ...
                        if (candidate.isDirectory() || fileName.endsWith(completedSuffix)
                                ...
                                || !fileName.startsWith(prefix) || isReaded(absFileName)
                                || isReading(absFileName) || isFailed(absFileName) ||
                        // 修改1分钟之外才会被处理
    ...
    public static class Builder {
        ...
        public YeeFileEventReader5 build() throws Exception {
            return new YeeFileEventReader5(clientProps, cacheClient, spoolDirectory,

...
package com.ideal.flume.lifecycle;
...
public class LifecycleSupervisor implements LifecycleAware {
  ...
  public LifecycleSupervisor() {
    ...
    monitorService = new ScheduledThreadPoolExecutor(10, new ThreadFactoryBuilder()
  ...
  public synchronized void supervise(LifecycleAware lifecycleAware, SupervisorPolicy policy,
    ...
    ScheduledFuture<?> future =
        monitorService.scheduleWithFixedDelay(monitorRunnable, 0, 3, TimeUnit.SECONDS);
  ...
  public static class Status {
    ...
    public String toString() {
      return "{ lastSeen:" + lastSeen + " lastSeenState:" + lastSeenState + " desiredState:"
          + desiredState + " firstSeen:" + firstSeen + " failures:" + failures + " discard:"
          + discard + " error:" + error + " }";
    }

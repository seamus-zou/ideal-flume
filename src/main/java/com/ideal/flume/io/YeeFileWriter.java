...
public class YeeFileWriter implements Closeable {

  private static final Logger logger = LoggerFactory.getLogger(YeeFileWriter.class);
   ...
   */
  public YeeFileWriter(Context context, CollectClient fileClient) {
  ...
  public void open(String filePath, CompressionCodec codec) throws Exception {
    ...
    serializer =
        EventSerializerFactory.getInstance(serializerType, serializerContext, outputStream);

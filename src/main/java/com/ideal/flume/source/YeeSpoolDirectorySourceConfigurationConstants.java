...
public class YeeSpoolDirectorySourceConfigurationConstants {
	/**
	...
	public static final String DEFAULT_REMOTE_TYPE = "LOCAL";
	...
	public static final String DEFAULT_REMOTE_USER_NAME = "anonymous";

	public static final String REMOTE_USER_PWD = "remotePassword";
	public static final String DEFAULT_REMOTE_USER_PWD = "anonymous";

	public static final String REMOTE_PASSIVE = "remotePassive";
	...
	public static final String DEFAULT_DELETE_POLICY = "CACHE";
	...
	public static final String DEFAULT_DECODE_ERROR_POLICY = DecodeErrorPolicy.IGNORE.name();
	...
	public static final String DYNAMIC_DIR_REG = "dynamicDirReg";

	public static final String SWITCH_TIME = "switchTime";
	public static final int DEFAULT_SWITCH_TIME = 2;

	public static final String READ_THREADS = "readThreads";
	...
	public static final String DATA_REPAIR_DIRECTORY = "dataRepairDir";

	public static final String CHECK_SUFFIX = "checkSuffix";

	public static final String DATA_FILE_TYPE = "dataFileType";

	public final static String READED_TMP_FILE = "/tmp/.flume/.readed/";
	public final static String READING_TMP_FILE = "/tmp/.flume/.reading/";
	public final static String FAILED_TMP_FILE = "/tmp/.flume/.failed/";

	public static final String EXTRA_LIB_PATH = "extraLibPath";
	public static final String EXTRA_CLASS = "extraClass";
	public static final String EXTRA_METHOD = "extraMethod";
}

...
public class KafkaSourceV10_2 extends AbstractSource implements Configurable, PollableSource {
  private static final Logger log = LoggerFactory.getLogger(KafkaSourceV10_2.class);
  ...
  public void configure(Context context) {
    tpAndOffsetMetadata = Maps.newHashMap();
